...
import { CreditCard, Plus, History, Star, Shield } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 relative overflow-hidden">
        ...
        {/* Features (один компактный блок, без дубликатов) */}
        <div className="px-4 pb-24">
          <div className="grid grid-cols-2 gap-4 mt-4">
            ...
            >
              ...
              <div className="text-gray-900 font-bold mb-2 text-lg">Безопасно</div>
              <div className="text-gray-600 text-sm">256-bit шифрование</div>
            </motion.div>
          </div>
        </div>
